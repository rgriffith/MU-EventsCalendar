<?
	...
	*/
	...
	class WECalendarEvent extends CascadeWebEvent
	{
		...
		{
			# soap service
			$this->service = new SoapClient("http://cascade.DOMAIN:8080/ws/services/AssetOperationService?wsdl", array('trace' => 1));
		
			#authentication vars
			$this->auth = array('username' => 'USER_WITH_WRITE_PRIVELEDGE', 'password' => 'PASSWORD');
		}
		...
		***************************************************/
		...
		{		
			...
			$this->event = array(
				...
				'publicPath' => 'PATH_TO_PENDING_FOLDER',
